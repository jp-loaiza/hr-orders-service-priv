...
# The following would break our deploy stage, as it relies to only $ENVIRONMENT-$BUILD_NUMBER
#IMAGE_TAG=${TIMESTAMP}
...
ibmcloud cr region-set us-south # The following command would fail without this
