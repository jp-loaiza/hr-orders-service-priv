...
const getOrderData = async (order) => {
  ...
  const orderData = {
    ...
    payment_method: order.paymentInfo ? order.paymentInfo.payments[0].obj.custom.fields.transaction_card_type : null,
    local: order.locale.replace('-', '_'),
    currency: order.totalPrice.currencyCode,
    user_agent: order.paymentInfo ? order.paymentInfo.payments[0].obj.custom.fields.user_agent_string : null,
