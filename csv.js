...
const getHeaderObjectFromOrder = ({
  ...
  [HEADER_ROWS_ENUM.BILL_TO_FIRST_NAME]: getFirstLastName(billingAddress, shippingAddress, false).firstName,
  [HEADER_ROWS_ENUM.BILL_TO_LAST_NAME]: getFirstLastName(billingAddress, shippingAddress, false).lastName,
