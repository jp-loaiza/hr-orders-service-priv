...
const COMPLETE_ORDER_ENGLISH_NEWLINES = {
  type: 'Order',
  id: '6feea16b-a8b1-4d3e-a602-8be1a70d0e05',
  version: 5,
  lastMessageSequenceNumber: 1,
...
const COMPLETE_ORDER_NO_PAYMENTS = {
  type: 'Order',
  id: '6feea16b-a8b1-4d3e-a602-8be1a70d0e05',
  version: 5,
  lastMessageSequenceNumber: 1,
  ...
  lineItems: [{
    ...
    variant: {
      ...
      },
      {
        name: 'construction',
        value: {
          'en-CA': '<li> Huge6/Genius5\n<li> Single-breasted, Two-button, Two-piece Suit\n<li> Notch lapel\n<li> Fully lined\n<li> Double vent\n<li> Flat front pant with 1/4 top pockets and besom back pockets\n<li> Unfinished hems',
          'fr-CA': '<li> Modèle Huge6/Genius5\n<li> Complet deux-pièces (veston à deux boutons, simple boutonnage)\n<li> Revers cranté\n<li> Entièrement doublé\n<li> Fente double\n<li> Pantalon sans plis avec poches en biais et poches arrière passepoilées\n<li> Bords inférieurs non finis'
        }
      },
      {
        name: 'fabricAndMaterials',
...
module.exports = {
  COMPLETE_ORDER_ENGLISH_UNTYPED,
  COMPLETE_ORDER_ENGLISH_NEWLINES,
  COMPLETE_ORDER_NO_PAYMENTS
}