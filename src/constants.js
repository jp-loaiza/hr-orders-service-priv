...
const ENDLESS_AISLE_SHIPPING_NAMES = {
  EXPRESS: 'Express', // REMOVE ME: Backup option, can be removed once the update in Bold is done
  STANDARD: 'Standard',
  NEXT_DAY: 'Next Day'
}

const ENDLESS_AISLE_SHIPPING_NAMES_TO_CARRIER_IDS = {
  [ENDLESS_AISLE_SHIPPING_NAMES.EXPRESS]: CARRIER_IDS.FDX, // REMOVE ME: Backup option, can be removed once the update in Bold is done
  [ENDLESS_AISLE_SHIPPING_NAMES.STANDARD]: CARRIER_IDS.FDX,
  [ENDLESS_AISLE_SHIPPING_NAMES.NEXT_DAY]: CARRIER_IDS.FDX
}

const ENDLESS_AISLE_SHIPPING_NAMES_TO_SHIPPING_SERVICE_TYPES = {
  [ENDLESS_AISLE_SHIPPING_NAMES.EXPRESS]: SHIPPING_SERVICE_TYPES.ECONOMY, // REMOVE ME: Backup option, can be removed once the update in Bold is done
  [ENDLESS_AISLE_SHIPPING_NAMES.STANDARD]: SHIPPING_SERVICE_TYPES.ECONOMY,
