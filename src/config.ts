...
export const ORDER_SAVE_MAX_BYTES_PER_PARTITION = parseInt(envProperties.INVENTORY_MAX_BYTES_PER_PARTITION ?? '1048576')
export const ORDER_SAVE_MAX_BYTES = parseInt(envProperties.INVENTORY_MAX_BYTES ?? '10485760')
export const ORDER_SAVE_CONCURRENT_PARTITIONS = parseInt(envProperties.INVENTORY_CONCURRENT_PARTITIONS ?? '1')
export const SERVER_PORT = envProperties.SERVER_PORT ?? 3000
